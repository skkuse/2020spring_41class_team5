  ...
  const getUserInfo = (data: any) => {
    ...
    return (
      ...
      <IonContent>
        <IonCard>
          <IonCardContent>
            <IonListHeader>KakaoTalk<IonIcon icon={chatbox}></IonIcon></IonListHeader>
            <IonList>Team5skku</IonList>
            <IonList>7 AM – 8:30 PM</IonList>
            <IonList>MON – SAT</IonList>
            <IonListHeader>Call us <IonIcon icon={call}></IonIcon></IonListHeader>
            <IonList>1234 – 9876</IonList>
            <IonList>8 AM – 4:30 PM</IonList>
            <IonList>MON – FRI</IonList>

            <IonListHeader>Email<IonIcon icon={mail}></IonIcon></IonListHeader>
